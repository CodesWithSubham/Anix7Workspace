    ...
    <Component
      className={twMerge(
        ...
        loading || (props as any).disabled
          ...
          : "hover:shadow-[inset_3px_3px_10px,inset_-3px_-3px_10px] hover:shadow-theme-600 hover:scale-102 hover:*:scale-95",
        className
      )}
      {...{
        ...(props as any),
...
export const IconButton = ({
  ...
  return (
    <Button
      className={twMerge(
        "inline-block shrink-0 bg-transparent rounded-full p-2 m-0 aspect-square hover:shadow-[inset_1px_1px_5px,inset_-1px_-1px_5px] text-inherit",
        className
      )}
      {...props}
    >
