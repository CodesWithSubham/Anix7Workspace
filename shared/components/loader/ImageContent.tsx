...
const ImageContent = (props: IContentLoaderProps) => {
  return (
    <ContentLoader
      viewBox="0 0 500 500"
      height={200}
      width={200}
      backgroundColor="color-mix(in oklch, var(--themeC) 10%, white)"
      foregroundColor="color-mix(in oklch, var(--themeC) 86%, white)"
      {...props}
    >
      ...
      <rect x="5" y="345" width="490" height="30" rx="3.83" />
      <rect x="5" y="395" width="490" height="30" rx="3.83" />
    </ContentLoader>
  );
};
